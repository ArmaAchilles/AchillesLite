...
if (isNil "Achillite_fnc_rscDialogDynamic") then
{
	Achillite_fnc_rscDialogDynamic = [missionNamespace, "Achillite_fnc_rscDialogDynamic", {}] call BIS_fnc_getServerVariable;
};
if (isNil "Achilles_fnc_sum") then
{
	Achilles_fnc_sum = [missionNamespace, "Achilles_fnc_sum", {}] call BIS_fnc_getServerVariable;
};
if (isNil "Achilles_fnc_textToVariableName") then
{
	Achilles_fnc_textToVariableName = [missionNamespace, "Achilles_fnc_textToVariableName", {}] call BIS_fnc_getServerVariable;
};
...
private _dialog = [] call Achillite_fnc_rscDialogDynamic;
